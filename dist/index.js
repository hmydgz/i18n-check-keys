(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('fs'), require('path'), require('@babel/parser'), require('@babel/traverse'), require('@babel/types'), require('chalk')) :
  typeof define === 'function' && define.amd ? define(['exports', 'fs', 'path', '@babel/parser', '@babel/traverse', '@babel/types', 'chalk'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.umd = {}, global.require$$0, global.require$$1, global.require$$2, global.require$$3, null, global.require$$5));
  ...
  exports.checkI18nKeys = checkI18nKeys_1;
  exports.default = src;
